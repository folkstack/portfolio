...
- Integrated AI Agent prompting (Google cloud, Gemini)
- Used agent coding for large portion of build
...
- Designed and built complete chess game
  ...
  - Game options UI and logic
- Built real-time websocket game server

## Open Source Projects and Publications
- Authored 80+ modules and published to NPM
- Designed, developed and published multiple creative apps and tools
- Contributed to Browserify and NPM
- Hundreds of repositories published to github
- Published machine learning, algorithms and mathematics projects, ex:
  - Neural Network Framework for GPU, WebGPU, C++
  - Demonstration of distributed training of NN weights
  - Signal Processing and numerical analysis
  - Code in Python and Javascript
- Designed and programmed Audio and Video effects
  - Programmatic Musical Composition (music as code)
  - Pure mathematical synthesis
  - Instrument modeling, and MIDI
- Dozens of songs published
- Real-time “live code” performance

## Teaching and Tutoring
- Personal tutor for front-end and NodeJS development
- Organizer and teacher for free programming school Cyberwizard Institute
- Tutored grade school students in code and music
